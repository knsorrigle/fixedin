...
- The similarity score is word overlap plus the identifier rule above, not semantic understanding. Messages without an identifier ("Unique constraint failed", "fetch failed") can still match unrelated issues; watch for the *weak match* label.
