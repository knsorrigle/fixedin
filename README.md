  ...
  test:
    ...
    steps:
      ...
      - name: Already fixed upstream?
        if: failure()
        uses: knsorrigle/fixedin@v0.6.2
        with:
          log: test.log
```
